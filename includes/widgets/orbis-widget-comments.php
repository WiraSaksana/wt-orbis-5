...
class Orbis_Comments_Widget extends WP_Widget {
	public function __construct() {
		parent::__construct( 'orbis-comments', __( 'Orbis - Comments', 'orbis-5' ) );
	}
				...
				<ul class="no-disc comments">
					<?php foreach ( $comments as $comment ) : ?>
						...
						if ( array_key_exists( 'orbis_keychain_password_request', $comment_meta ) ) {
							$label = __( 'Keychain', 'orbis-5' );
							$class = 'label-info';
						} elseif ( array_key_exists( 'orbis_subscription_extend_request', $comment_meta ) ) {
							$label = __( 'Subscription', 'orbis-5' );
							$class = 'label-success';
						} else {
							$label = __( 'Comment', 'orbis-5' );
							$class = 'label-default';
						}
						...
						<li>
							...
							<div class="comment-content">
								...
								<span class="entry-meta">
									...
									printf(
										esc_html__( 'Posted by %1$s on %2$s', 'orbis-5' ),

...
class Orbis_Theme_Admin {
	...
	private function get_tiny_mce_style_formats() {
		return [
			...
			[
				'title' => __( 'Buttons', 'orbis-5' ),
				'items' => [
					[
						'title'    => __( 'Default', 'orbis-5' ),
						'selector' => 'a',
						'classes'  => 'btn',
					],
					[
						'title'    => __( 'Primary', 'orbis-5' ),
						'selector' => '.btn',
						'classes'  => 'btn-primary',
					],
					[
						'title'    => __( 'Success', 'orbis-5' ),
						'selector' => '.btn',
						'classes'  => 'btn-success',
					],
					[
						'title'    => __( 'Info', 'orbis-5' ),
						'selector' => '.btn',
						'classes'  => 'btn-info',
					],
					[
						'title'    => __( 'Warning', 'orbis-5' ),
						'selector' => '.btn',
						'classes'  => 'btn-warning',
					],
					[
						'title'    => __( 'Danger', 'orbis-5' ),
						'selector' => '.btn',
						'classes'  => 'btn-danger',
					],
					[
						'title'    => __( 'Link', 'orbis-5' ),
						'selector' => '.btn',
						'classes'  => 'btn-link',
					],
				],
			...
			[
				...
				'items' => [
					...
					[
						'title'    => __( 'Inverse', 'orbis-5' ),
						'selector' => '.table',
						'classes'  => 'table-inverse',
					],
					[
						'title'    => __( 'Striped Rows', 'orbis-5' ),
						'selector' => '.table',
						'classes'  => 'table-striped',
					],
					[
						'title'    => __( 'Bordered Table', 'orbis-5' ),
						'selector' => '.table',
						'classes'  => 'table-bordered',
					],
					[
						'title'    => __( 'Hover Rows', 'orbis-5' ),
						'selector' => '.table',
						'classes'  => 'table-hover',
					],
					[
						'title'    => __( 'Small Table', 'orbis-5' ),
						'selector' => '.table',
						'classes'  => 'table-sm',
					],
				],
			...
			[
				...
				'items' => [
					...
					[
						'title'    => __( 'Reverse Layout', 'orbis-5' ),
						'selector' => '.blockquote',

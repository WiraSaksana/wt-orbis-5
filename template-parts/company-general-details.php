...
<dl>
	...
	<?php if ( ! empty( $website ) ) : ?>
		...
		<dt><?php esc_html_e( 'Website', 'orbis-5' ); ?></dt>
		<dd>
	...
	<?php if ( ! empty( $email ) ) : ?>
		...
		<dt><?php esc_html_e( 'E-Mail', 'orbis-5' ); ?></dt>
		<dd>
	...
	<?php if ( ! empty( $accounting_email ) ) : ?>
		...
		<dt><?php esc_html_e( 'Accounting E-Mail', 'orbis-5' ); ?></dt>
		<dd>
	...
	<?php if ( ! empty( $invoice_email ) ) : ?>
		...
		<dt><?php esc_html_e( 'Invoice E-Mail', 'orbis-5' ); ?></dt>
		<dd>
	...
	<?php if ( ! empty( $kvk_number ) ) : ?>
		...
		<dt><?php esc_html_e( 'KvK Number', 'orbis-5' ); ?></dt>
		<dd>
	...
	<?php if ( ! empty( $vat_number ) ) : ?>
		...
		<dt><?php esc_html_e( 'VAT Number', 'orbis-5' ); ?></dt>
	...
	<?php if ( has_term( null, 'orbis_invoice_shipping_method' ) ) : ?>
		...
		<dt><?php esc_html_e( 'Invoice Shipping Method', 'orbis-5' ); ?></dt>
	...
	<?php if ( ! empty( $twinfield_customer_id ) ) : ?>
		...
		<dt><?php esc_html_e( 'Twinfield ID', 'orbis-5' ); ?></dt>
		<dd>
			<?php
